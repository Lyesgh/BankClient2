...
public class MainFrame extends JFrame implements Runnable, Observateur {
    ...
    private void configurerFenetrePrincipale() {
        ...
        //Modifier l'apparence par defaut de l'application et ses composantes a celle de Windows
        try {
            javax.swing.UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
        } catch (ClassNotFoundException | IllegalAccessException | InstantiationException | UnsupportedLookAndFeelException e) {System.out.println("Erreur de look and feel"); }
